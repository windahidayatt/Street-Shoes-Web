...
<body>
    <?php
        ...
        if(isset($_SESSION['status_pembeli'])){
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" style="padding-right: 0 !important; padding-left: 0 !important;">
                                        ...
                                        <!-- Checkout ver tanpa ngisi form -->
                                        <a class="btn btn-secondary btn-lg btn-block" href="../layout_main/layout_main.php?content=<?php echo '../pages_main/checkout.php'?>" role="button">Checkout</a>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
            ...
            ?>
            <p style="color : #F6B5AC; text-align:center;">Please login.</p>
            <?php
        }
